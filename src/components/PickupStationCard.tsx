    ...
    >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 text-jumia-gray text-xs mt-1">
                <MapPin className="h-3.5 w-3.5 text-jumia-orange shrink-0" />
                <span className="line-clamp-1">{station.address}</span>
              </div>
              {station.landmark && (
                <div className="text-xs text-jumia-gray/90 mt-0.5 line-clamp-1">
                  <span className="font-medium text-jumia-dark/70">Landmark:</span> {station.landmark}
                </div>
              )}
            </div>
          </div>
      ...
      <CardContent className="pb-4 pt-2 px-4 space-y-3">
        <div className="flex items-center justify-between text-xs pt-1 border-t border-gray-100">
          ...
          <div className="text-jumia-gray flex items-center gap-1">
            <Clock className="h-3.5 w-3.5 text-jumia-orange" />
            <span>{station.timeOpenedWeek || "Mon - Sat"}</span>
          </div>
        </div>
